  ...
  [8],
  {
    '0fb2': function (e, a, t) {
      ...
      function n(e, a, t, n, o, i) {
        const c = Object(r['B'])('w06')
        return (
          Object(r['u'])(), Object(r['e'])('div', null, [Object(r['h'])(c)])
        )
      }
      const o = Object(r['I'])('data-v-db5c3cec')
      Object(r['x'])('data-v-db5c3cec')
      const i = { id: 'canva' },
      ...
      t('e537')
      ;(d.render = s), (d.__scopeId = 'data-v-db5c3cec')
      var u = d,
        h = Object(r['i'])({ components: { W06: u }, name: 'PageIndex' })
      h.render = n
      a['default'] = h
    },
    c1a8: function (e, a, t) {},
